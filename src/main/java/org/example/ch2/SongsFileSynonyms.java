...
public class SongsFileSynonyms {
    public static void main(String[] args) throws Exception {
        var path = Paths.get("target/idx/ch2/songs_file_synonyms");
    ...
    private static Analyzer getIndexTimeSynonymAnalyzer() throws Exception {
        var synonymsFilterArgs = new HashMap<String, String>();
        synonymsFilterArgs.put("synonyms", "ch2/synonyms.txt");
        synonymsFilterArgs.put("ignoreCase", "true");

        return CustomAnalyzer.builder()
                .withTokenizer(WhitespaceTokenizerFactory.class)
                .addTokenFilter(SynonymGraphFilterFactory.class, synonymsFilterArgs)
                .build();
    }
